...
shared_examples_for 'voted' do
  ...
  describe 'POST #vote_up' do
    ...
    context 'as not the author' do
      ...
      it 'render json' do
        vote_up
        expect(response.body).to eq({ id: votable.id, value: votable.sum_value, have_vote: true, positive_vote: true, type: model.classify }.to_json)
      end
    end
  ...
  describe 'POST #vote_down' do
    ...
    context 'as not the author' do
      ...
      it 'render json' do
        vote_down
        expect(response.body).to eq({ id: votable.id, value: votable.sum_value, have_vote: true, positive_vote: false, type: model.classify }.to_json)
      end
    end
  ...
  describe 'POST #vote_cancel' do
    ...
    context 'as not the author' do
      ...
      it 'render json' do
        expect(response.body).to eq({ id: votable.id, value: votable.sum_value, have_vote: false, type: model.classify }.to_json)
      end
    end
